...
def CombineRun2(Workspace_path, Mass, Width):
    for Widthpoint in Width:
      ...
      for Masspoint in Mass:
        print >> shFile_mu, "combineCards.py 2016=%s/2016/%s/datacard_ttZprime_mu_%s.txt 2017=%s/2017/%s/datacard_ttZprime_mu_%s.txt 2018=%s/2018/%s/datacard_ttZprime_mu_%s.txt > %s/datacard_ttZprime_mu_%s.txt" % (Workspace_path,Widthpoint,Masspoint,Workspace_path,Widthpoint,Masspoint,Workspace_path,Widthpoint,Masspoint,Run2_datacard_path,Masspoint)
        print >> shFile_e, "combineCards.py 2016=%s/2016/%s/datacard_ttZprime_e_%s.txt 2017=%s/2017/%s/datacard_ttZprime_e_%s.txt 2018=%s/2018/%s/datacard_ttZprime_e_%s.txt > %s/datacard_ttZprime_e_%s.txt" % (Workspace_path,Widthpoint,Masspoint,Workspace_path,Widthpoint,Masspoint,Workspace_path,Widthpoint,Masspoint,Run2_datacard_path,Masspoint)
        print >> shFile, "combineCards.py 2016=%s/2016/%s/datacard_ttZprime_%s.txt 2017=%s/2017/%s/datacard_ttZprime_%s.txt 2018=%s/2018/%s/datacard_ttZprime_%s.txt > %s/datacard_ttZprime_%s.txt" % (Workspace_path,Widthpoint,Masspoint,Workspace_path,Widthpoint,Masspoint,Workspace_path,Widthpoint,Masspoint,Run2_datacard_path,Masspoint)
        os.system("combineCards.py 2016=%s/2016/%s/datacard_ttZprime_mu_%s.txt 2017=%s/2017/%s/datacard_ttZprime_mu_%s.txt 2018=%s/2018/%s/datacard_ttZprime_mu_%s.txt > %s/datacard_ttZprime_mu_%s.txt" % (Workspace_path,Widthpoint,Masspoint,Workspace_path,Widthpoint,Masspoint,Workspace_path,Widthpoint,Masspoint,Run2_datacard_path,Masspoint))
        os.system("combineCards.py 2016=%s/2016/%s/datacard_ttZprime_e_%s.txt 2017=%s/2017/%s/datacard_ttZprime_e_%s.txt 2018=%s/2018/%s/datacard_ttZprime_e_%s.txt > %s/datacard_ttZprime_e_%s.txt" % (Workspace_path,Widthpoint,Masspoint,Workspace_path,Widthpoint,Masspoint,Workspace_path,Widthpoint,Masspoint,Run2_datacard_path,Masspoint))
        os.system("combineCards.py 2016=%s/2016/%s/datacard_ttZprime_%s.txt 2017=%s/2017/%s/datacard_ttZprime_%s.txt 2018=%s/2018/%s/datacard_ttZprime_%s.txt > %s/datacard_ttZprime_%s.txt" % (Workspace_path,Widthpoint,Masspoint,Workspace_path,Widthpoint,Masspoint,Workspace_path,Widthpoint,Masspoint,Run2_datacard_path,Masspoint))
      print "combine cards finish"
